...
description: Conduz o fluxo de criação de uma feature usando spec.md, plan.md, tasks.md, tests.md e review.md. Use quando o aluno pedir para criar ou evoluir uma feature em um projeto maior (Fase 07 em diante).
---
...
1. Ler `CLAUDE.md` e `GUIA_SPEC_DRIVEN_DEVELOPER.md`.
